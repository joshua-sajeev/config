...
_G.packer_plugins = {
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/home/joshua/.local/share/nvim/site/pack/packer/start/cmp-cmdline",
  ...
  ["lualine-time"] = {
    loaded = true,
    path = "/home/joshua/.local/share/nvim/site/pack/packer/start/lualine-time",
  ...
  ["neodev.nvim"] = {
    loaded = true,
    path = "/home/joshua/.local/share/nvim/site/pack/packer/start/neodev.nvim",
  ...
  ["nvim-ts-rainbow"] = {
    loaded = true,
    path = "/home/joshua/.local/share/nvim/site/pack/packer/start/nvim-ts-rainbow",
